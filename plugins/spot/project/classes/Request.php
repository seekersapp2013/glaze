<?php
namespace Spot\Project\Classes;
use \ZipArchive;
use RainLab\User\Facades\Auth;
use \Spot\Project\Classes\FontsToDownload;
class Request {
   ...
   public function DB() {
       ...
       if(isset($_POST['id'])){
           $project             =   \Spot\Project\Models\Project::find($_POST['id']);
           $file = (new \System\Models\File)->fromData($data, 'project.supra');
           $project->file()->add($file);
           $project->updated_at =   \Carbon\Carbon::now();
           $project->update();
       }else{
           $project             =   new \Spot\Project\Models\Project;
